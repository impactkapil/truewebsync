    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <form method="GET"
                      action="{{ route('customer.shopify.orders.index') }}"
                    ...
                    <label for="search" class="form-label fw-bold me-2 mb-0">
                        Search Orders:
                    </label>
                    <input type="text"
                           name="search"
                    ...
                    <label for="per_page" class="form-label fw-bold me-2 mb-0">
